...
QMAKE    = /usr/bin/qmake
recruitmentApp.xcodeproj/project.pbxproj: recruitmentApp.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o recruitmentApp.xcodeproj/project.pbxproj recruitmentApp.pro
